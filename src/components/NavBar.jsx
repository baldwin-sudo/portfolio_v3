...
export default function NavBar({ scrollToSection }) {
  ...
  return (
    <div className="z-50 pointer-events-auto bg-white/70 backdrop-blur-3xl fixed top-0 left-1/2 -translate-x-1/2 sm:m-5 flex flex-wrap items-center justify-center sm:rounded-full w-full sm:w-fit sm:flex-nowrap gap-1 sm:gap-8 py-4 px-15 sm:px-4 shadow-lg">
      <motion.div
